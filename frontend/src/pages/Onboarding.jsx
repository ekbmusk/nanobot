...
const LEVELS = [
  { id: '1', emoji: '🟢', title: 'Негізгі', desc: 'Түсініктер мен қарапайым есептер', sub: 'Нанотехнология негіздері, атом құрылысы',     color: '#10B981' },
  { id: '2', emoji: '🟡', title: 'Орташа',  desc: 'Талдау мен формулалар қолдану',     sub: 'Құрылым, қасиеттер, есептеулер',              color: '#F59E0B' },
  { id: '3', emoji: '🔴', title: 'Күрделі', desc: 'Зерттеу мен модельдеу деңгейі',    sub: 'Синтез, кванттық есептеулер, болжау',          color: '#EF4444' },
]
